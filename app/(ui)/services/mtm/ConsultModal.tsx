...
export default function ConsultModal({ isOpen, onClose }: ConsultModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (typeof window !== 'undefined' && window.gtag) {
      window.gtag('event', 'mtm_consult_submit', {
        event_category: 'conversion',
        event_label: 'MTM Consultation Request'
      });
    }
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-neutral-200 p-6 flex justify-between items-center">
          <h2 className="text-2xl font-semibold text-brand-navy">Book MTM Consultation</h2>
          <button
            onClick={onClose}
          ...
          <div className="p-6 text-center" aria-live="polite">
            <div className="mb-4">
              ...
              <p className="text-slate-600">
                We'll contact you within 24 hours to schedule your MTM consultation. Thank you for choosing Xpress Care Pharmacy.
              </p>
            </div>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-amber-700 text-sm">
                  Please don't include specific medical information in this form. We'll discuss your medications and health concerns during your private consultation.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-neutral-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#10254D]/50 focus:border-[#10254D]"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-3 py-2 border border-neutral-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#10254D]/50 focus:border-[#10254D]"
                placeholder="e.g., 5-7 medications"
              />
            </div>

            <div>
              <label htmlFor="concerns" className="block text-sm font-medium text-brand-navy mb-2">
                General Concerns (Optional)
              </label>
              <textarea
                id="concerns"
                name="concerns"
                ...
                onChange={handleChange}
                className="w-full px-3 py-2 border border-neutral-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#10254D]/50 focus:border-[#10254D]"
                placeholder="e.g., side effects, medication timing, interactions"
              />
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4">
              ...
              <button
                type="button"
                onClick={onClose}
                className="flex-1 text-center border border-neutral-300 text-slate-600 py-3 px-6 rounded-md hover:bg-neutral-50 transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-300 focus:ring-offset-2"
              >
                Cancel
              </button>
            </div>
